...
def main():
    ...
    Blue2=np.asarray([0,0,244])
    Blue3=np.asarray([0,0,234])
    Blue4=np.asarray([0,0,223])

    Red1=np.asarray([255,0,0])
    Red2=np.asarray([196,0,0])
    Red3=np.asarray([185,0,0])
    Red4=np.asarray([174,0,0])

    Yellow1=np.asarray([255,255,51])
    Yellow2=np.asarray([255,255,64])
    Yellow3=np.asarray([255,255,80])
    Yellow4=np.asarray([255,255,96])

    Orange1=np.asarray([255,163,0])
    Orange2=np.asarray([255,109,28])
    Orange3=np.asarray([255,138,57])
    Orange4=np.asarray([255,163,82])
    ...
    for image_index in range(len(pathname_list)):
      ...
      patch_shape = (100,100,3)#H,W,channels
      #change step if patch_shape change width
      patches = view_as_windows(img, patch_shape,step=100)
      #BUFFER=[]
    ...
    print(col_count)
    f=open(input_path+'Counter_and_vocab_info.txt','w')
    print(col_count,file=f)
    ...
    for ind in range(len(words)):
        print('visual_word_index:',ind,' visual_word_name:',words[ind],file=f)
    f.close()
