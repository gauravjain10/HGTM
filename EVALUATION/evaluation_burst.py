...
def main():
    ...
    voc_dic={'Blue1':[0,0,255],'Blue2':[  0,   0, 244],'Blue3':[  0,   0, 234],'Blue4':[  0,   0, 223],\
         'Red1':[255,0,0],'Red2':[196,   0,   0],'Red3':[185,   0,   0],'Red4':[174,   0,   0],\
         'Yellow1':[255, 255,   51],'Yellow2':[255, 255,   64],'Yellow3':[255, 255,   80],'Yellow4':[255, 255,   96],\
         'Orange1':[255, 163,   0],'Orange2':[255, 109,   28],'Orange3':[255, 138,   57],'Orange4':[255, 163,   82]}
